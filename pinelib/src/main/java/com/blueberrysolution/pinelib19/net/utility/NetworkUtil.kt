package com.blueberrysolution.pinelib19.net.utility
...
object NetworkUtil {
     ...
     * @return
     */
    fun isNeedSetProxyForNetRequest(): Boolean { // #00044 +
        return if (Build.MODEL == "SCH-N719" || Build.MODEL == "SCH-I939D") {
            false
        } else {
            true
        }
